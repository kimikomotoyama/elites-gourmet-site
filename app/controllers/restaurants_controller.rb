class RestaurantsController < ApplicationController
  ...
  def confirm
    if params[:id].present?
      ...
      if @restaurant.invalid?
        ...
        flash.now[:alert] = I18n.t('restaurant.image_error')
        render :edit
      end
    else
  ...
  private
  def input_params
    params.require(:restaurant).permit(:name, :telephone_number, :address, :has_private_room, :seat_count, :open_date, :about, genre_ids: [], restaurant_images_attributes: [:id, :image, :image_cache])
  end
end